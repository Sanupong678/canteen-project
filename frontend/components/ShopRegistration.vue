                ...
                <div class="form-group">
                  ...
                  <div class="login-credentials">
                    ...
                    <div class="credential-group">
                      ...
                      >
                      <div v-if="shop.password && shop.confirmPassword && !isPasswordMatch" class="error-message">
                        รหัสผ่านไม่ตรงกัน
                      </div>
                    </div>
                  </div>
...
const isPasswordMatch = computed(() => {
  return shop.value.password === shop.value.confirmPassword
})
...
const handleSubmit = () => {
  if (!isEditMode.value) {
    ...
    if (!shop.value.username || !shop.value.password || !shop.value.confirmPassword) {
  ...
  emit('add-shop', {
    ...
    isExpired: isContractExpired.value
  })
